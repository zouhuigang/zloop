...
> **这份是索引，正文在 [`docs/CODE-AUDIT.md`](../../docs/audit/CODE-AUDIT.md)。**
...
> [§4 发现清单](../../docs/audit/CODE-AUDIT.md#4-发现清单)；③ 正文里一条已有的锚点链接本身就是坏的
...
|---|---|---|---|---|---|---|
| 1 | A-1 | 高 | `install --claude-stop-hook` 撞上形状不对的 settings.json 就 panic | 已修 | `c917421` | [§4](../../docs/audit/CODE-AUDIT.md#a-1高zloop-install---claude-stop-hook-在-settingsjson-结构不对时-panic--已修) |
| 2 | A-2 | 中 | `remember --rule` 读-改-写无锁，并发丢条目 | 已修 | `d07d003` | [§5](../../docs/audit/CODE-AUDIT.md#a-2中zloop-remember---rule-并发会丢条目--已修t6commit-d07d003) |
| 3 | A-3 | 低 | 残留 `state.json.tmp` 没人清，`doctor` 也不说 | 已修 | `d07d003` | [§5](../../docs/audit/CODE-AUDIT.md#a-3低被杀之后留下-statejsontmpdoctor-说没发现问题--已修t6commit-d07d003) |
| 4 | A-4 | 高 | NOTES.md 一个非 UTF-8 字节 → 约定和经验静默清零并被真删掉 | 已修 | `36b0e3c` `90f2c5d` | [§6](../../docs/audit/CODE-AUDIT.md#a-4高notesmd-里一个非-utf-8-字节--约定和经验静默清零下一次-remember---rule-把它们真删掉--已修) |
| 5 | A-5 | 高 | `--exit-on-wait` 在「等人」时从不生效（实测空转 20 小时） | 已修 | `8131c7c` | [§6](../../docs/audit/CODE-AUDIT.md#a-5高--exit-on-wait-在等人时从不生效它只在一种-runner-自己走不到的状态下才管用--已修) |
| 6 | A-6 | 高 | 超时管不住留下孙进程的那一轮，期间 SIGTERM 叫不动 | 已修 | `ca2074b` | [§6](../../docs/audit/CODE-AUDIT.md#a-6高超时管不住留下后台进程的那一轮而且这段时间里-sigterm-叫不动-runner--已修) |
| 7 | A-7 | 中 | `policy.window_hours` 越界 → `next`/`status`/`context` 全 panic | 已修 | `c917421` `1e6f103` | [§6](../../docs/audit/CODE-AUDIT.md#a-7中policywindow_hours-手滑一下next--status--context-全-panic而-doctor-说没问题--已修)、[§6 复核](../../docs/audit/CODE-AUDIT.md#a-7-复核t28两处钳位分属两条分支cli-面只盖住了一条) |
| 8 | A-8 | 中 | 时间参数「装得下 i64」就 panic，装不下反而有好提示 | 已修 | `c917421` | [§6](../../docs/audit/CODE-AUDIT.md#a-8中时间参数装得下-i64就-panic装不下反而有好错误提示--已修) |
| 9 | A-9 | 中高 | 依赖成环没人拦，永久卡死且 `doctor` 无诊断 | 已修 | `ba87ca2` | [§7](../../docs/audit/CODE-AUDIT.md#a-9中高依赖成环没人拦永久卡死且无诊断--已修) |
| 10 | A-10 | 中 | 「0 = 关掉这个检查」只对五个阈值里的三个成立 | 已修 | `ba87ca2` | [§7](../../docs/audit/CODE-AUDIT.md#a-10中0--关掉这个检查只对三个阈值成立--已修) |
| 11 | A-11 | 高 | 时钟跳到未来 + 撞配额 = runner 睡 72 年，面板一切正常 | 已修 | `0ff7fe0` | [§7](../../docs/audit/CODE-AUDIT.md#a-11高时钟跳到未来--撞配额--runner-睡-72-年而-status-看着一切正常--已修) |
| 12 | A-12 | 高 | `--git-commit` 的 checkpoint 提交整个工作树 | 已修 | `3c1865b` | [§8](../../docs/audit/CODE-AUDIT.md#a-12高--git-commit-的-checkpoint-提交整个工作树--已修) |
| 13 | A-13 | 高 | 基线只拍一次，长跑中途邻居新建的文件都算我们的 | 已修 | `15106bf` | [§8](../../docs/audit/CODE-AUDIT.md#a-13高快照只拍一次长跑中途冒出来的都算我们的--已修) |
| 14 | A-14 | 高 | git 一挂住 runner 跟着挂住，SIGTERM 叫不动 | 已修 | `7d18b26` | [§9](../../docs/audit/CODE-AUDIT.md#a-14高git-一挂住runner-跟着挂住而且-sigterm-叫不动它--已修) |
| 15 | A-15 | 中高 | 写回路上的裸 git 挂住 → 整轮的账和技术文档不落盘 | 已修 | `7384774` | [§9](../../docs/audit/CODE-AUDIT.md#a-15中高写回路上的裸-git-挂住--这一轮的账和技术文档一个字都没落盘--已修) |
| 16 | A-16 | 中高 | 人敲三下 `zloop next`，长跑就拒绝启动（noop 计数跨进程串味） | 已修 | `1811382` | [§10](../../docs/audit/CODE-AUDIT.md#a-16中高noop-计数从交互式命令串进-runner-的停机判断人敲三下-zloop-next就能让长跑拒绝启动--已修) |
| 17 | A-17 | 高 | 人插一句 `feedback`，失败的一轮被记成「写回了」 | 已修 | `6ff3793` | [§11](../../docs/audit/CODE-AUDIT.md#a-17高人插一句-zloop-feedback一轮失败的宿主就被记成写回了连续失败停机整个失效--已修) |
| 18 | A-18 | 中 | `compact` 把花费一起归档走，`max_total_usd` 静默复位 | 已修 | `73c16cb` | [§11](../../docs/audit/CODE-AUDIT.md#a-18中zloop-compact-把花费一起归档走max_total_usd-静默复位--已修) |
| 19 | A-19 | 中高 | 人留一句反馈，下一轮无头 runner 就 `--resume` 进人的对话 | 已修 | `4dd8499` | [§11](../../docs/audit/CODE-AUDIT.md#a-19中高人留一句反馈下一轮无头-runner-就---resume-进人的对话里--已修) |
| 20 | A-20 | 高 | 改**别的** todo 就把连续失败停机这道闸拆了 | 已修 | `73740b7` | [§12](../../docs/audit/CODE-AUDIT.md#a-20高人顺手整理-backlogzloop-edit-改别的-todo连续失败停机这道闸就被拆了--已修) |
| 21 | A-21 | 高 | 一句 `feedback` 让「原地踏步」那道闸永远数不到上限 | 已修 | `73740b7` | [§12](../../docs/audit/CODE-AUDIT.md#a-21高人插一句-zloop-feedback同一条-todo-原地踏步那道闸就永远数不到上限--已修) |
| 22 | A-22 | 中高 | 依赖一条已延后的 todo：一样永远等不到，`doctor` 却退 0 | 已修 | `cf29c2b` | [§13](../../docs/audit/CODE-AUDIT.md#a-22中高依赖一条已延后的-todo卡死的形状一模一样doctor-却退-0--已修) |
| 23 | B-1 | 低 | `Decision` 的 "should_run ⇒ todo 非空" 没人守（绊子，非 bug） | 已修 | 本轮（t10） | [§4](../../docs/audit/CODE-AUDIT.md#b-1低decision-的-should_run--todo-非空-不变量没人守--已修t10) |
| 24 | B-2 | 低 | `edit <id> --blocked-by <它自己>` 被收下，那条 todo 永久卡死 | 已修 | `ba87ca2` | [§6](../../docs/audit/CODE-AUDIT.md#b-2低edit-id---blocked-by-它自己-被收下那条-todo-就再也跑不了--已修t12commit-ba87ca2) |
| 25 | B-3 | 中 | 全部 deferred 时说「目标结束」，引着人去开新目标 | 已修 | `e768b5d` | [§7](../../docs/audit/CODE-AUDIT.md#b-3重估为中全部-deferred-时说目标结束并引着人去开新目标--已修) |
| 26 | T21 | 中 | `awake.rs` 8 处裸子进程（收口 5 处，留 3 处并写明理由） | 已修 | `7941e6d` | [§19](../../docs/audit/CODE-AUDIT.md#19-第十六轮t21中awakers-的-8-处裸子进程--收口-5-处留-3-处并写明理由) |
| 27 | T29 | 中 | `compact` 把「跑了几轮」一起搬走，四处读数清零 | 已修 | `6e85fcc` | [§21](../../docs/audit/CODE-AUDIT.md#t29中一次例行整理把-status--stats--replan--轮次编号四处读数一起清零--已修) |
| 28 | T30 | 中 | 格式闸全红 = 没有闸（缺 `rustfmt.toml`） | 已修 | `ac040d3` `ffb6f59` | [§2.1](../../docs/audit/CODE-AUDIT.md#21-格式闸原先是空的已修t30) |
| 29 | T31 | 中 | 闸有定义但没人自动按（没有 CI） | 已修 | `789d524` | [§2.2](../../docs/audit/CODE-AUDIT.md#22-闸有了定义但没人自动去按已修t31) |
| 30 | T32 | 中 | `policy.intervals_min` 越界：debug 崩、release 睡 8171 年 | 已修 | `dc7e714` | — |
| 31 | T33 | 低 | 阶梯写反 `[30,10,3]` 三件事一起反过来，`doctor` 沉默 | 已修 | `7dc358e` | — |
| 32 | T34 | 低 | `slowest_interval` 用 `.last()` 取「最慢的一档」，阶梯非单调时拿的不是最大值 | 已修（改名，行为照旧） | `6fc6aa5` | — |
| 33 | T36-① | 低 | `tests/scratch_t33.rs` 被误提交（文件里写着"未被 git 跟踪"） | 已清 | `503e427` | [§14](../../docs/audit/CODE-AUDIT.md#t36-低testsscratch_t33rs-被误提交进仓库--已清) |
| 34 | T36-② | 中 | `status` 对「永远等不到」和「正常排队」用同一个词 | 已修 | `503e427` | [§14](../../docs/audit/CODE-AUDIT.md#t36-中status-对永远等不到和正常排队用同一个词--已修) |
| 35 | T37 | 中 | 「永远等不到」只在 `status` 一块屏上说了（另三处清单还在骗人） | 已修 | `bca786a` | [§14](../../docs/audit/CODE-AUDIT.md#t37中永远等不到只在-status-一块屏上说了--已修并补上-t36-漏判的那一半) |
| 36 | T38 | 中 | 延后一条依赖 = 一条命令判死一片，回显只字不提 | 已修 | `0c27d16` | — |
| 37 | T39 | 中高 | `compact` 搬走还有人依赖的那条，等它的几条永远等不到 | 已修 | `c441398` | [§15](../../docs/audit/CODE-AUDIT.md#t39中高compact-把还有人依赖的那条搬进归档等它的那几条就此永远等不到--已修) |
| 38 | T40-① | 中高 | 例行 `compact` 吃掉人今天刚留下、还没人读过的反馈 | 已修 | `331293a` `5304382` | [§16.2](../../docs/audit/CODE-AUDIT.md#162-t40-中高例行-compact-吃掉人今天刚留下的还没人读过的反馈--已修见-17)、[§17](../../docs/audit/CODE-AUDIT.md#17-第十四轮compact-剩下的两处指针一起收口t40--已修) |
| 39 | T40-② | 中 | `compact --force` 搬走在飞的那条，`ensure_idle` 的两条出口都退 2 | 已修 | `331293a` `5304382` | [§16.3](../../docs/audit/CODE-AUDIT.md#163-t40-中compact---force-把在飞的那条搬走ensure_idle-给的两条出口从此都退-2--已修见-17)、[§17](../../docs/audit/CODE-AUDIT.md#17-第十四轮compact-剩下的两处指针一起收口t40--已修) |
| 40 | T42 | 中高 | 派活指着一条已了结的 todo 时，四处出口一起坏 | 已修 | `2e0168f` | [§18](../../docs/audit/CODE-AUDIT.md#18-第十五轮t42中高派活指着一条已了结的-todo-时四处出口一起坏--已修) |
| 41 | T43 | 中 | `install_sudoers` 的暂存路径别人占得住名字 | 已修 | `b406ded` | [§20](../../docs/audit/CODE-AUDIT.md#t43中install_sudoers-的暂存路径别人也能占名装进-etcsudoersd-的可以不是我们写的那份--已修) |
| 42 | T44 | 中 | 整理一次账本，进度条 66% → 0%、「一次过 2/2」→「0/0」 | 已修 | `71e5c8a` | [§22](../../docs/audit/CODE-AUDIT.md#t44中整理一次账本进度条-66--0一次过-2200--已修) |

**42 已修（含 T36-① 的"已清"）/ 0 未修 / 0 不修。**
...
- **状态**：已修 · 回归测试 `cli_test::a_wrongly_shaped_settings_json_is_reported_not_panicked_or_clobbered`（三层分别换回 `.expect()` 都变红）· 正文：[§4 · A-1](../../docs/audit/CODE-AUDIT.md#a-1高zloop-install---claude-stop-hook-在-settingsjson-结构不对时-panic--已修)
...
- **状态**：已修 · `notes.rs` 的读-改-写走 `state::locked`（NOTES 自己一把锁，见 `lock_target`）· 正文：[§5 第二轮 · A-2](../../docs/audit/CODE-AUDIT.md#a-2中zloop-remember---rule-并发会丢条目--已修t6commit-d07d003)
...
- **状态**：已修 · `doctor.rs::check_leftover_tmp` · 正文：[§5 第二轮 · A-3](../../docs/audit/CODE-AUDIT.md#a-3低被杀之后留下-statejsontmpdoctor-说没发现问题--已修t6commit-d07d003)
...
- **状态**：已修（两个 commit：写侧 + 体检侧）· 正文：[§6 第三轮 · A-4](../../docs/audit/CODE-AUDIT.md#a-4高notesmd-里一个非-utf-8-字节--约定和经验静默清零下一次-remember---rule-把它们真删掉--已修)
...
- **状态**：已修 · 回归测试 `runner_test::exit_on_wait_stops_the_first_time_the_runner_itself_hits_a_human_gate` + 新增 `run_within()` 助手（这类回归撤掉修复是**挂住**而不是变红，挂住的测试没人当成失败）· 正文：[§6 第三轮 · A-5](../../docs/audit/CODE-AUDIT.md#a-5高--exit-on-wait-在等人时从不生效它只在一种-runner-自己走不到的状态下才管用--已修)
...
- **状态**：已修 · 正文：[§6 第三轮 · A-6](../../docs/audit/CODE-AUDIT.md#a-6高超时管不住留下后台进程的那一轮而且这段时间里-sigterm-叫不动-runner--已修)
...
- **状态**：已修 · 回归测试 `an_out_of_range_window_hours_gets_clamped_instead_of_panicking` 等；**t28 复核发现两处钳位分属两条分支、CLI 面只盖住了一条**，`1e6f103` 补上第二处的覆盖 · 正文：[§6 第三轮 · A-7](../../docs/audit/CODE-AUDIT.md#a-7中policywindow_hours-手滑一下next--status--context-全-panic而-doctor-说没问题--已修)、[§6 第三轮 · A-7 复核（t28）](../../docs/audit/CODE-AUDIT.md#a-7-复核t28两处钳位分属两条分支cli-面只盖住了一条)
...
- **状态**：已修 · 回归测试 `out_of_range_time_arguments_get_the_same_friendly_error_as_garbage` · 正文：[§6 第三轮 · A-8](../../docs/audit/CODE-AUDIT.md#a-8中时间参数装得下-i64就-panic装不下反而有好错误提示--已修)
...
- **状态**：已修 · 回归测试三条（`doctor_test.rs`，二元环用**真命令**造）· 正文：[§7 第四轮 · A-9](../../docs/audit/CODE-AUDIT.md#a-9中高依赖成环没人拦永久卡死且无诊断--已修)
...
- **状态**：已修 · 回归测试 `tick_test::zero_turns_a_threshold_off_the_same_way_for_all_five` · 正文：[§7 第四轮 · A-10](../../docs/audit/CODE-AUDIT.md#a-10中0--关掉这个检查只对三个阈值成立--已修)
...
- **状态**：已修 · 回归测试两条（单元 `a_future_tick_cannot_stretch_the_throttle_wait_past_the_window` + 精确到分钟的 `22*60+1` 那条一起钉住）· 正文：[§7 第四轮 · A-11](../../docs/audit/CODE-AUDIT.md#a-11高时钟跳到未来--撞配额--runner-睡-72-年而-status-看着一切正常--已修)
...
- **状态**：已修 · 正文：[§8 第五轮 · A-12](../../docs/audit/CODE-AUDIT.md#a-12高--git-commit-的-checkpoint-提交整个工作树--已修)
...
- **状态**：已修 · 正文：[§8 第五轮 · A-13](../../docs/audit/CODE-AUDIT.md#a-13高快照只拍一次长跑中途冒出来的都算我们的--已修)
...
- **状态**：已修 · 正文：[§9 第六轮 · A-14](../../docs/audit/CODE-AUDIT.md#a-14高git-一挂住runner-跟着挂住而且-sigterm-叫不动它--已修)
...
- **状态**：已修 · 回归测试两条（`runner_test.rs`，各自撤掉对应修复就变红）· 正文：[§9 第六轮 · A-15](../../docs/audit/CODE-AUDIT.md#a-15中高写回路上的裸-git-挂住--这一轮的账和技术文档一个字都没落盘--已修)
...
- **状态**：已修 · 正文：[§10 第七轮 · A-16](../../docs/audit/CODE-AUDIT.md#a-16中高noop-计数从交互式命令串进-runner-的停机判断人敲三下-zloop-next就能让长跑拒绝启动--已修)
...
- **状态**：已修 · 回归测试三条，撤掉对应修复就变红 · 正文：[§11 第八轮 · A-17](../../docs/audit/CODE-AUDIT.md#a-17高人插一句-zloop-feedback一轮失败的宿主就被记成写回了连续失败停机整个失效--已修)
...
- **状态**：已修 · 正文：[§11 第八轮 · A-18](../../docs/audit/CODE-AUDIT.md#a-18中zloop-compact-把花费一起归档走max_total_usd-静默复位--已修) ·**这条只是第一个受害者**，同族的 T29 / T44 在后面
...
- **状态**：已修 · 正文：[§11 第八轮 · A-19](../../docs/audit/CODE-AUDIT.md#a-19中高人留一句反馈下一轮无头-runner-就---resume-进人的对话里--已修)
...
- **状态**：已修 · 回归测试两条，各自撤掉对应修复就变红 · 正文：[§12 第九轮 · A-20](../../docs/audit/CODE-AUDIT.md#a-20高人顺手整理-backlogzloop-edit-改别的-todo连续失败停机这道闸就被拆了--已修)
...
- **状态**：已修 · 正文：[§12 第九轮 · A-21](../../docs/audit/CODE-AUDIT.md#a-21高人插一句-zloop-feedback同一条-todo-原地踏步那道闸就永远数不到上限--已修)
...
- **状态**：已修 · 回归测试三条（撤掉 `can_still_finish` 判据前两条立刻变红）· 正文：[§13 第十轮 · A-22](../../docs/audit/CODE-AUDIT.md#a-22中高依赖一条已延后的-todo卡死的形状一模一样doctor-却退-0--已修)
...
- **状态**：已修 · 回归测试 `tick_test::every_decide_exit_keeps_should_run_implies_a_todo` · 正文：[§4 · B-1](../../docs/audit/CODE-AUDIT.md#b-1低decision-的-should_run--todo-非空-不变量没人守--已修t10)
...
- **状态**：已修（修 A-9 时一起做的，t10 复核时才把状态补正——**这一轮没有改代码**）· 回归测试 `cli_test::edit_refuses_to_make_a_todo_depend_on_itself` + 手改文件那条由 `doctor_test::a_self_dependency_from_a_hand_edited_file_is_reported_but_a_finished_dep_is_not` 兜 · 正文：[§6 第三轮 · B-2](../../docs/audit/CODE-AUDIT.md#b-2低edit-id---blocked-by-它自己-被收下那条-todo-就再也跑不了--已修t12commit-ba87ca2)
...
- **状态**：已修 · 回归测试 `tick_test::all_deferred_is_not_all_done` · 正文：[§7 第四轮 · B-3](../../docs/audit/CODE-AUDIT.md#b-3重估为中全部-deferred-时说目标结束并引着人去开新目标--已修)
...
- **状态**：已修 ·**这一轮真正的发现是反的**：无脑套 `run_capture` 会把恢复默认值弄没——`zloop stop` 的 SIGTERM 先把 `stop_requested()` 置上，收尾路径上的 `pmset` 探针要是也认叫停，会在第一次轮询里被自己杀掉，`SleepDisabled=1` 原地留着。所以 `run_capture` 多了一个显式的 `Stop` 参数 · 正文：[§19 第十六轮 · T21](../../docs/audit/CODE-AUDIT.md#19-第十六轮t21中awakers-的-8-处裸子进程--收口-5-处留-3-处并写明理由)
...
- **状态**：已修 ·**A-18 只补了花费那一个，同族还有 6 个原地等着**——修一类"累计量被搬走"的 bug 时先问它是不是一族 · 正文：[§21 第十八轮 · T29](../../docs/audit/CODE-AUDIT.md#t29中一次例行整理把-status--stats--replan--轮次编号四处读数一起清零--已修)
...
- **状态**：已修 · 正文：[§2.1 格式闸原先是空的（已修，t30）](../../docs/audit/CODE-AUDIT.md#21-格式闸原先是空的已修t30)
...
- **状态**：已修 ·**加闸前先跑一遍**：`clippy -D warnings` 本来就有 4 条红，直接配进 CI 就是开局全红——那正是 t30 判过死刑的假闸 · 正文：[§2.2 闸有了定义，但没人自动去按（已修，t31）](../../docs/audit/CODE-AUDIT.md#22-闸有了定义但没人自动去按已修t31)
...
#### T34（低）· 已修 `6fc6aa5`（改名，行为照旧）
- **标题**：`runner::slowest_interval` 用 `.last()` 取「最慢的一档」，阶梯非单调时它拿到的不是最大值
- **复现**：`intervals_min = [3, 30, 10]` → `slowest_interval` 拿到 10，真正最慢是 30
- **修复前**：函数名和文档写的都是"最慢"，而「等人」「被限流」「被 host 限流」三处 sleep 都读它——**是那句话错了，不是那个值错了**
- **结论：照末档，改名**。两条路的代价：
  - 取 `max()` → 间隔会在退避耗尽的那一刻**反弹回去**。`decide` 自己的退避序列走到末档就停（`tick::interval` 里的 `level.min(len - 1)`），runner 的 fallback 是这条序列耗尽之后的续写：`[3, 30, 10]` 下 `decide` 给 30 → 10 → 10，取 max 就接成 30 → 10 → 10 → **30**，同一个字段的两个读者对"阶梯的尽头在哪"给出两个答案。而且它等于**替用户决定"阶梯就该是升序的"**——`[3, 30, 10]` 也可能是存心的（先狠退一次，之后稳定在 10 分钟）。
  - 照末档 + 改名 → 名字不再撒谎，行为一分不动；阶梯往回走的代价由 `doctor` 的 `bad_policy` warn 说（T33），runner 不替人纠正顺序。失败方向也是良性的：拿到 10 只是比"最大值"多看几眼，不是睡死（`clamp_interval` 挡着）也不是忙等（下限 1 挡着）。
- **改动**：`runner::slowest_interval` 整个删掉，换成 `tick::ladder_tail(state) = interval(state, usize::MAX)`——`policy.intervals_min` 从此**只有一个读者**（T32 的根因就是第二个读者绕过了闸）。附带修掉一处不一致：旧实现空清单时自带第二套默认值 30，而 `doctor` 的空清单 warn 写的是"退回写死的 3 分钟"（`tick::interval` 的值）；现在两边都是 3。
- **验收**：`tests/runner_test.rs::the_wait_fallback_is_the_ladders_last_rung_not_its_largest` 钉住 `[3, 30, 10]` 的完整序列 `(30, 10, 10, 10)`；改成 `.max()` → `left: (30, 10, 10, 30)` 变红，退回旧的 `unwrap_or(30)` → 空清单那条 `left: 30 / right: 3` 变红
- **状态**：已修 · 正文：**无**——正文里没有这一条，全部记录就是本条草稿
...
- **验收**：死等和排队在面板上分得开
- **状态**：已修 · 回归测试 `cli_test::status_tells_a_dead_wait_apart_from_a_normal_queue` · 正文：[§14 第十一轮 · T36-②](../../docs/audit/CODE-AUDIT.md#t36-中status-对永远等不到和正常排队用同一个词--已修)
...
- **验收**：四处一起说，且**判据只留一份**
- **状态**：已修 · 正文：[§14 第十一轮 · T37](../../docs/audit/CODE-AUDIT.md#t37中永远等不到只在-status-一块屏上说了--已修并补上-t36-漏判的那一半)
...
- **验收**：还有人依赖的那条不许搬
- **状态**：已修 · 正文：[§15 第十二轮 · T39](../../docs/audit/CODE-AUDIT.md#t39中高compact-把还有人依赖的那条搬进归档等它的那几条就此永远等不到--已修)
...
- **状态**：已修 · 正文：[§16.2 T40-①](../../docs/audit/CODE-AUDIT.md#162-t40-中高例行-compact-吃掉人今天刚留下的还没人读过的反馈--已修见-17)、[§17 第十四轮](../../docs/audit/CODE-AUDIT.md#17-第十四轮compact-剩下的两处指针一起收口t40--已修)
...
- **状态**：已修 · 正文：[§16.3 T40-②](../../docs/audit/CODE-AUDIT.md#163-t40-中compact---force-把在飞的那条搬走ensure_idle-给的两条出口从此都退-2--已修见-17)、[§17 第十四轮](../../docs/audit/CODE-AUDIT.md#17-第十四轮compact-剩下的两处指针一起收口t40--已修)
...
- **状态**：已修 · 正文：[§18 第十五轮 · T42](../../docs/audit/CODE-AUDIT.md#18-第十五轮t42中高派活指着一条已了结的-todo-时四处出口一起坏--已修)
...
- **状态**：已修 ·**顺带纠正了一句写错的前提**：macOS 上「TMPDIR 没设 = /tmp」不成立，Apple 平台 `env::temp_dir()` 走 `confstr(_CS_DARWIN_USER_TEMP_DIR)`，拿到的是每用户 0700 的 `/var/folders/…/T/`（`env -i` 实测）。可利用性因此收窄，但修法不变 · 正文：[§20 第十七轮 · T43](../../docs/audit/CODE-AUDIT.md#t43中install_sudoers-的暂存路径别人也能占名装进-etcsudoersd-的可以不是我们写的那份--已修)

#### T44（中）· 已修 `71e5c8a`
- **标题**：整理一次账本，进度条 66% → 0%、「一次过 2/2」→「0/0」、`goals` 的 2/3 → 0/1
- **复现**：`sh scripts/repro-t44-compact-drops-progress-percent.sh`（修之前退 1）
- **修复前**：T29 修的是从 **ticks** 现算的那一族，从 **todo** 现算的还有两个没修（[§21.4](../../docs/audit/CODE-AUDIT.md#214-没修的那一半说清楚别当没看见) 明写过），这一轮做掉并发现第三个出口
- **验收**：归档汇总里再存一份「todo 那一侧的原料」；顺带修掉「整理干净的目标被说成刚开的」（`total == 0 && archived.todos == 0` 才算待规划）
- **状态**：已修 ·**这是同一个教训第三次出现**：为「空账本 = 刚开始」准备的早退分支，`compact` 都能伪造它的前提 · 正文：[§22 第十九轮 · T44](../../docs/audit/CODE-AUDIT.md#t44中整理一次账本进度条-66--0一次过-2200--已修)
